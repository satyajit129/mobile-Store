...
<script src="{{ asset('admin/source/plugins/DataTables/DataTables-1.10.18/js/jquery.dataTables.min.js') }}"></script>
...
<script src="{{ asset('admin/theme/js/mono.js') }}"></script>
<script src="{{ asset('admin/theme/js/chart.js') }}"></script>
<script src="{{ asset('admin/theme/js/map.js') }}"></script>
